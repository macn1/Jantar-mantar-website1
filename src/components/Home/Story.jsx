      ...
      <div className='story d-flex flex-column justify-content-center  '>
        ...
        <div className='container'>
          ...
          <div className='row '>
            ...
            <div className='img col-12  col-md-6 text-center p-3 mt-5'>
            ...
            <div className='col-12  col-md-6  text-white mt-5 mb-4'>


              <h1 className='font fs-1'>The Story of Jantar Mantar</h1>
